...
class IsaacDepthDataStatistics(DataStats):
    def __init__(self):
        super().__init__(
            name="Isaac depth data stats",
            max=10.0,
            min=0.0,
            mean=2.0504225541580356,
            std=2.2127892597905983,
        )


class IsaacFlatDepthDataStatistics(DataStats):
    def __init__(self):
        super().__init__(
            name="IsaacFlat depth data stats",
            max=10.0,
            min=0.0,
            mean=4.1534354721207185,
            std=3.5033295206429815,
        )
...
def get_depth_data_stats(
    ...
    IsaacDepthDataStatistics,
    IsaacFlatDepthDataStatistics,
]:
    ...
    data_stats = {
        ...
        True: {
            ...
            "isaac": IsaacDepthDataStatistics(),
            "isaac_flat": IsaacFlatDepthDataStatistics(),
        },
    }
