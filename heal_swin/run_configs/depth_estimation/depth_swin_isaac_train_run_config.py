...
def get_train_run_config():
    ...
    from heal_swin.models_lightning.depth_estimation.model_lightning_depth_swin_hp_sobel import (
        WoodscapeDepthSwinHPSobelConfig,
    )
    from heal_swin.training.optimizer import OptimizerConfig, LightningReduceLROnPlateau
