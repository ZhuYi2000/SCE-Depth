...
class WoodscapeHPDepthSobelImagesDataset(WoodscapeDataset):
    ...
    def __init__(
        ...
        dataset_name = "hp_depth_images_nside=128_base_pix=8_0511_sobel"
        print("SCE-Depth for CompoundDepth:" + dataset_name)
        ...
        #         + " generating dataset..."
        #     )
        #     from sce_depth.data.depth_estimation import project_depth_on_s2
...
class WoodscapeHPDepthImagesPredictDataset(Dataset):
    ...
    def __init__(
        ...
        if isinstance(samples, float):  # samples is fraction of dataset to take
            ...
            dummy_ds = WoodscapeHPDepthSobelImagesDataset(
                part="train",
        ...
        self.hp_imgs_masks_dataset = WoodscapeHPDepthSobelImagesDataset(
            part=part,
            train_share=train_share,
            data_transform=data_transform,
            normalize_data=normalize_data,
...
class WoodscapeHPSobelHPDepthDataModule(LightningDataModule):
    def __init__(
        self,
        batch_size,
        val_batch_size,
        ...
        **kwargs,
        ...
        self.train_dataset = WoodscapeHPDepthSobelImagesDataset(
            part="train",
            data_transform=data_transform,
            normalize_data=normalize_data,
            mask_background=mask_background,
        ...
        self.val_dataset = WoodscapeHPDepthSobelImagesDataset(
            part="val",
            data_transform=data_transform,
            normalize_data=normalize_data,
            mask_background=mask_background,
    ...
    def _ensure_pred_dataset(self) -> None:
        if self.pred_dataset is None:
            self.pred_dataset = WoodscapeHPDepthImagesPredictDataset(**self._pred_dataset_kwargs)
