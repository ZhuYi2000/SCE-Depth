...
from sce_depth.data.depth_estimation import isaacFlat_depth_datasets
from sce_depth.data.depth_estimation import normalize_depth_data
from sce_depth.evaluation.flat_depth_pred_writers import WoodscapeDepthFlatBasePredictionWriter
from sce_depth.evaluation import flat_depth_pred_writers


class IsaacFlatDepthDataModule(LightningDataModule):
    def __init__(
        self,
        batch_size,
        val_batch_size,
        ...
        **kwargs,
        ...
        self.depth_data_statistics = (
            normalize_depth_data.IsaacFlatDepthDataStatistics()
            if mask_background
            else normalize_depth_data.IsaacFlatDepthDataStatistics()
        )
        ...
        print("Init train and val...")
        train_dataset = val_dataset = isaacFlat_depth_datasets.IsaacFlatDepthDataset
        print("Init pred...")
        pred_dataset = isaacFlat_depth_datasets.IsaacFlatDepthImagesPredictDataset
