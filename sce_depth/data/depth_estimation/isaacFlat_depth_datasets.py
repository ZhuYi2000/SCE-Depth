...
from sce_depth.utils import utils
from sce_depth.utils import get_paths
from sce_depth.data.depth_estimation import normalize_depth_data
from sce_depth.utils import depth_utils
from sce_depth.data.depth_estimation import hp_depth_datasets
from sce_depth.data.isaac_dataset import IsaacDataset
...
class IsaacFlatDepthImagesDataset(IsaacDataset):
    ...
    def get_dir(self) -> str:
        ...
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFlatFov5Mean")
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFlatFov3Mean")
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFisheyeFlat")
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFisheyeFlat1402")
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFisheyeFlat2730_clear")
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFisheyeFlat1364")
        return os.path.join(syn_path, "rgb_images/rgb_images_isaacFisheyeFlat1364_0511")# high100
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFisheyeFlat1364_high16")
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFov70Flat")
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFlatFisheyeTest")
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFlatFisheyeTestWare16")
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFlatFisheyeTestOffice24")
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFlatFov5Mean2730")
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFlatFov3Mean1364")
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFlatFov3Mean2730Mercator-70")
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFlatFov3Mean1364_2025")
        # return os.path.join(syn_path, "rgb_images/rgb_images_isaacFlatFov3Mean2730_2025")
    ...
    def __getitem__(self, idx) -> torch.Tensor:
        ...
        # print("img size from IsaacFlatDepthImagesDataset", img.size())
        return self.transform(img)


class IsaacFlatDepthMaskDataset(IsaacDataset):
    """Dataset of Woodscape RGB images (depth maps)"""
    ...
    def get_dir(self) -> str:
        syn_path = get_paths.get_syn_datasets_path()
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFlatFov5Mean")
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFlatFov3Mean")
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFisheyeFlat")
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFisheyeFlat1402")
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFisheyeFlat2730_clear")
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFisheyeFlat1364")
        return os.path.join(syn_path, "depth_maps/raw_data_isaacFisheyeFlat1364_0511")# high100
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFisheyeFlat1364_high16")
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFov70Flat")
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFlatFisheyeTest")
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFlatFisheyeTestWare16")
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFlatFisheyeTestOffice24")
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFlatFov5Mean2730")
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFlatFov3Mean1364")
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFlatFov3Mean2730Mercator-70")
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFlatFov3Mean1364_2025")
        # return os.path.join(syn_path, "depth_maps/raw_data_isaacFlatFov3Mean2730_2025")
...
class IsaacFlatDepthDataset(Dataset):
    def __init__(
        self,
        size=None,
        crop_green=False,
        ...
        **kwargs,
        ...
        self.imgs_dataset = IsaacFlatDepthImagesDataset(*args, **kwargs)
        self.depth_masks_dataset = IsaacFlatDepthMaskDataset(
            *args,
            **kwargs,
        )
        ...
        self.padding = tv.transforms.Pad([0, 0, 0, 0])
        ...
        )  # data_transform = 'isaac'
        print(self.imgs_dataset.get_dir())
    ...
    def __getitem__(self, idx) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        # print("img size from IsaacFlatDepthDataset", img.size(), type(img))
        # print("self.img_transform", self.img_transform)
        img = self.img_transform(img)
        # print("img size from IsaacFlatDepthDataset img_transform", img.size(), type(img))
        img = self.padding(img)
        # print("img size from IsaacFlatDepthDataset padding", img.size(), type(img))
        ...
        if self.data_transform:   # data_transform = 'isaac'
        ...
        # print("img size from IsaacFlatDepthDataset after", img.size(), type(img))
        return img, mask

class IsaacFlatDepthCalibrationDataset(IsaacDataset):
...
class IsaacFlatDepthImagesCalibrationDataset(Dataset):

    """Dataset of Woodscape RGB images, segmentation masks(depth maps) and calibration infos"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.cals_dataset = IsaacFlatDepthCalibrationDataset(*args, **kwargs)
        ...
        self.masks_dataset = IsaacFlatDepthMaskDataset(
            *args,
            **kwargs,
        )
...
class IsaacFlatDepthImagesPredictDataset(Dataset):
    ...
    def __init__(
        ...
        if isinstance(samples, float):  # samples is fraction of dataset to take
            ...
            dummy_ds = IsaacFlatDepthDataset(part="train", train_share=1.0, **dataset_kwargs)
        ...
        self.transf_sem_img_dataset = IsaacFlatDepthDataset(
        ...
        self.sem_img_dataset = IsaacFlatDepthImagesCalibrationDataset(
            data_transform=data_transform,
            mask_background=mask_background,
            normalize_data=normalize_data,
            **dataset_kwargs,
