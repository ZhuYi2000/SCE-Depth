...
from sce_depth.utils import utils, get_paths, depth_utils
from sce_depth.data.depth_estimation import normalize_depth_data, flat_depth_datasets
from sce_depth.data.woodscape_dataset import WoodscapeDataset
from sce_depth.data.isaac_dataset import IsaacDataset



class IsaacHPDepthSobelImagesDataset(IsaacDataset):
    ...
    def __init__(
        ...
        # dataset_name = '1364Fov3'
        
        # dataset_name = "isaac_depth_images_nside=128_base_pix=8_eye_fov=3.0_max_depth=10.0_dataset_size=1683_compound_eye=ico20609+close+sobel"
        # dataset_name = "2d3d_nside=128_base_pix=12_max_depth=10.0_dataset_size=1413+sobel"
        # dataset_name = "2d3d_nside=128_base_pix=8_max_depth=10.0_dataset_size=2826+sobel"
        
        # dataset_name = "isaac_depth_images_nside=128_base_pix=8_Test_eye_fov=3.0_max_depth=10.0_dataset_size=162_compound_eye=ico20609+close+sobel"
        ...
        # dataset_name = "fisheye_depth_images_nside=128_base_pix=8_1364_0511_sobel"
        # dataset_name = "fisheye_depth_images_nside=128_base_pix=8_1364_sobel"
        ...
        print("sobel-version-0302, self.paths: ", self.paths[0], "len(self.paths)", len(self.paths))
    ...
    def __getitem__(self, idx) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        hp_sobel = torch.tensor(data["hp_sobel"])
        ...
        return hp_img, hp_mask, hp_sobel
...
class IsaacHPDepthImagesPredictDataset(Dataset):
    ...
    def __init__(
        ...
        if isinstance(samples, float):  # samples is fraction of dataset to take
            ...
            dummy_ds = IsaacHPDepthSobelImagesDataset(
                part="train",
        ...
        self.hp_imgs_masks_dataset = IsaacHPDepthSobelImagesDataset(
            part=part,
            train_share=train_share,
            data_transform=data_transform,
            normalize_data=normalize_data,
...
class IsaacSobelHPDepthDataModule(LightningDataModule):
    def __init__(
        self,
        batch_size,
        val_batch_size,
        ...
        **kwargs,
        ...
        self.train_dataset = IsaacHPDepthSobelImagesDataset(
            part="train",
            data_transform=data_transform,
            normalize_data=normalize_data,
            mask_background=mask_background,
        ...
        self.val_dataset = IsaacHPDepthSobelImagesDataset(
            part="val",
            data_transform=data_transform,
            normalize_data=normalize_data,
            mask_background=mask_background,
    ...
    def get_img_dims(self) -> Tuple[int, int]:
        img, mask, sobel = self.train_dataset[0]
        return img.shape[-1]
    ...
    def get_pred_writer(
        ...
        from sce_depth.evaluation import hp_depth_pred_writers
        self._ensure_pred_dataset()
