...
from sce_depth.models_lightning.models_lightning import MODEL_CONFIGS_LITERAL
...
class SingleModelTrainRun:
    ...
    model: MODEL_CONFIGS_LITERAL = field(default_factory=WoodscapeDepthSwinHPConfig)
