...
from sce_depth.data.segmentation.project_on_s2 import project_hp_mask_back
...
class DepthRelSE(Metric):  # Relative Squared Error
    def __init__(
        self,
        total_mean,
        compute_on_step=True,
...
class DepthRelAE(Metric):  # Relative Absolute Error
    def __init__(
        self,
        total_mean,
        compute_on_step=True,
...
class DepthiRMSE(Metric):  # Inverse Root Mean Squared Error
    def __init__(
        self,
        compute_on_step=True,
        dist_sync_on_step=False,
...
class DepthRangeMSE(Metric):  # Mean Squared Error in a certain range
    def __init__(
        self,
        compute_on_step=True,
        dist_sync_on_step=False,
