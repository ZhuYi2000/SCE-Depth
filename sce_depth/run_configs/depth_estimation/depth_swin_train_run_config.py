...
def get_train_run_config():
    ...
    from sce_depth.models_lightning.depth_estimation.model_lightning_depth_swin import (
        WoodscapeDepthSwinConfig,
    )
    from sce_depth.models_torch.swin_transformer import SwinTransformerConfig
