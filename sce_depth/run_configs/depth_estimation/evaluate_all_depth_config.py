...
# zhu-20241023:
# python3 run.py --env singularity inference_isaac --config_path=sce_depth/run_configs/depth_estimation/evaluate_all_depth_config.py
#######################################################################
...
def get_eval_run_config():
    ...
    from sce_depth.data.data_config import WoodscapeDepthFlatConfig, WoodscapeHPDepthConfig, WoodscapeISAACDepthConfig, WoodscapeISAACFlatDepthConfig, WoodscapeISAACDepthSobelConfig
