...
import sce_depth.training.logging_callbacks as callbacks
from sce_depth.models_lightning import models_lightning
from sce_depth.utils import serialize
from sce_depth.data import data

from sce_depth.evaluation.evaluate_config import EvaluateConfig
from sce_depth.training.train_config import PLConfig
from sce_depth.utils import get_paths, utils
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_path",
        type=str,
        default="sce_depth/run_configs/depth_estimation/evaluate_all_depth_config.py",
