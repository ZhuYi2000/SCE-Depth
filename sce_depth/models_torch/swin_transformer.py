...
class SwinTransformerSys(nn.Module):
    ...
    def __init__(self, config: SwinTransformerConfig, data_spec: DataSpec, **kwargs):
        ...
        def get_error_str(HW, f1, f2, f3, corr):
            ...
            return result
        # print("(H / (merge_factor * patch_height * window_height)) % 1: ", (H / (merge_factor * patch_height * window_height)) % 1)
        # print(f'H:{H}, merge_factor:{merge_factor}, patch_height:{patch_height}, window_height:{window_height}')
        ...
        # print("(W / (merge_factor * patch_width * window_width)) % 1: ", (W / (merge_factor * patch_width * window_width)) % 1)
        # print(f'W:{W}, merge_factor:{merge_factor}, patch_width:{patch_width}, window_width:{window_width}')
